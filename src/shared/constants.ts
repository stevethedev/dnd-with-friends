...
export const MAX_PANEL_WIDTH_FRACTION = 0.80  // panels may not exceed 80% of window width
...
export const BEYOND20_GITHUB_API = 'https://api.github.com/repos/kakaroto/Beyond20/releases/latest'
